                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">Rp 3,000</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1.5 text-xs font-medium rounded-full bg-green-50 text-green-700 border border-green-100">
                                        Tersedia
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <img src="/api/placeholder/48/48" alt=""
                                            class="h-12 w-12 rounded-lg object-cover shadow-sm">
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">Aqua</div>
                                            <div class="text-sm text-gray-500">Air Mineral</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600">AQA-002</td>
                                <td class="px-6 py-4 text-sm text-gray-600">Minuman</td>
                                <td class="px-6 py-4 text-sm text-gray-600">85</td>
                                <td class="px-6 py-4 text-sm text-gray-600">Rp 3,000</td>
                                <td class="px-6 py-4 text-sm text-gray-600">Rp 4,000</td>
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1.5 text-xs font-medium rounded-full bg-yellow-50 text-yellow-700 border border-yellow-100">
                                        Stok Menipis
                                    </span>
                                </td>
                                <td class="px-6 py-4">
